...
function Chips_li_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("click", function Chips_li_3_Template_li_click_0_listener($event) {
      ...
      return ɵɵresetView(ctx_r23.onItemContextMenu($event, item_r4));
    });
...
function Chips_li_7_TimesIcon_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("click", function Chips_li_7_TimesIcon_1_Template_TimesIcon_click_0_listener() {
      ...
      return ɵɵresetView(ctx_r26.clear());
    });
    ɵɵelementEnd();
  }
  if (rf & 2) {
...
var Chips = class _Chips {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    inputs: {
      ...
      inputId: "inputId",
      allowDuplicate: ["allowDuplicate", "allowDuplicate", booleanAttribute],
      caseSensitiveDuplication: ["caseSensitiveDuplication", "caseSensitiveDuplication", booleanAttribute],
      inputStyle: "inputStyle",
      inputStyleClass: "inputStyleClass",
      addOnTab: ["addOnTab", "addOnTab", booleanAttribute],
      addOnBlur: ["addOnBlur", "addOnBlur", booleanAttribute],
      separator: "separator",
    ...
    decls: 8,
    vars: 34,
    consts: [[3, "ngClass", "ngStyle"], ["tabindex", "-1", "role", "listbox", 3, "ngClass", "click", "focus", "blur", "keydown"], ["container", ""], ["role", "option", 3, "ngClass", "click", "contextmenu", 4, "ngFor", "ngForOf"], ["role", "option", 1, "p-chips-input-token", 3, "ngClass"], ["type", "text", "pAutoFocus", "", 3, "disabled", "ngStyle", "autofocus", "keydown", "input", "paste", "focus", "blur"], ["inputtext", ""], [4, "ngIf"], ["role", "option", 3, "ngClass", "click", "contextmenu"], ["token", ""], [4, "ngTemplateOutlet", "ngTemplateOutletContext"], ["class", "p-chips-token-label", 4, "ngIf"], [1, "p-chips-token-label"], [3, "styleClass", "click", 4, "ngIf"], ["class", "p-chips-token-icon", 3, "click", 4, "ngIf"], [3, "styleClass", "click"], [1, "p-chips-token-icon", 3, "click"], [4, "ngTemplateOutlet"], ["class", "p-chips-clear-icon", 3, "click", 4, "ngIf"], [1, "p-chips-clear-icon", 3, "click"]],
    template: function Chips_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        ɵɵproperty("ngClass", ɵɵpureFunction4(25, _c4, ctx.disabled, ctx.focused, ctx.value && ctx.value.length || (ctx.inputViewChild == null ? null : ctx.inputViewChild.nativeElement.value) && (ctx.inputViewChild == null ? null : ctx.inputViewChild.nativeElement.value.length), ctx.focused))("ngStyle", ctx.style);
        ɵɵattribute("data-pc-name", "chips")("data-pc-section", "root");
        ɵɵadvance(1);
        ɵɵproperty("ngClass", ɵɵpureFunction1(30, _c5, ctx.variant === "filled" || ctx.config.inputStyle() === "filled"));
        ...
        ɵɵadvance(1);
        ɵɵproperty("ngClass", ɵɵpureFunction1(32, _c6, ctx.showClear && !ctx.disabled));

...
function SelectButton_div_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("role", ctx_r1.multiple ? "checkbox" : "radio")("ngClass", ɵɵpureFunction3(14, _c2, ctx_r1.isSelected(option_r2), ctx_r1.disabled || ctx_r1.isOptionDisabled(option_r2), option_r2.icon && !ctx_r1.getOptionLabel(option_r2)))("autofocus", ctx_r1.autofocus);
    ɵɵattribute("tabindex", i_r3 === ctx_r1.focusedIndex && !ctx_r1.disabled ? "0" : "-1")("aria-label", option_r2.label)("aria-checked", ctx_r1.isSelected(option_r2))("aria-disabled", ctx_r1.optionDisabled)("title", option_r2.title)("aria-labelledby", ctx_r1.getOptionLabel(option_r2))("data-pc-section", "button");
    ɵɵadvance(1);
...
//# sourceMappingURL=chunk-6IZKJMWB.js.map
